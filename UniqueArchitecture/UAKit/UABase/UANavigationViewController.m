...
@interface UANavigationViewController (){
    CGPoint       startTouch;
...
@implementation UANavigationViewController
- (void)dealloc
{
...
- (void)viewDidLoad {
    ...
    if ([self.navigationBar respondsToSelector:@selector(setBackgroundImage:forBarMetrics:)]) {
        [[UINavigationBar appearance]setBackgroundImage:[UIImage imageNamed:@"header_bg_ios7_ip4"] forBarMetrics:UIBarMetricsDefault];
        ...
        [[UINavigationBar appearance] setBackIndicatorImage:[UIImage imageNamed:@"header_leftbtn_press"]];
        [[UINavigationBar appearance] setBackIndicatorTransitionMaskImage:[UIImage imageNamed:@"Icon"]];
